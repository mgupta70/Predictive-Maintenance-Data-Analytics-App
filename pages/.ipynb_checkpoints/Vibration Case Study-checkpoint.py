...
## Embed html as (Method-1) ##
# HtmlFile = open("media/1.html", 'r', encoding='utf-8')
# source_code = HtmlFile.read() 
# print(source_code)
# components.html(source_code, height=600)

## Embed html as (Simpler Method-2) ##
# height = 500
# file = open("media/4.html", 'r', encoding='utf-8')
# components.html(file.read() , height=height)
...
# file = open("media/5.html", 'r', encoding='utf-8')
# components.html(file.read() , height=height)
